...
int main(int argc, char *argv[])
{
    ...
    {                               // Make the selected door by player,
        size_t const selected = random() % 3;
                                    // and prize door randomly 0, 1, or 2.
        size_t const prize = random() % 3;
        ...
        size_t const suggested = 3 - opened - selected;
